...
Referential integrity can be ensure our data is not corrupt when there are relationships among tables. 
- on delete cassade - to delete the target record if its parent gets deleted
