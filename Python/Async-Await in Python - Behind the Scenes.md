...
![Screenshot_2024-02-09_at_2.05.01_PM](https://raw.githubusercontent.com/sounak07/backend-engineering/main/assets/Screenshot_2024-02-09_at_2.05.01_PM.png)
...
We can assign a number threads allowed to be used so that the server can't use too many of them. Below is the implementation in python using python standard **_concurrent.futures_** module.
...
_Refer to article for an example_
