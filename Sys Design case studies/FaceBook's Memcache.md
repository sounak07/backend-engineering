...
Facebook uses Memcache as a _Demand filled look aside cache_ , it means data goes it cache only if requested i.e., demand filled and its first checks the cache before checking the database.

![Screenshot_2024-03-08_at_11.38.33_PM](https://raw.githubusercontent.com/sounak07/backend-engineering/main/assets/Screenshot_2024-03-08_at_11.38.33_PM.png)
...
![Screenshot_2024-03-08_at_11.52.23_PM](https://raw.githubusercontent.com/sounak07/backend-engineering/main/assets/Screenshot_2024-03-08_at_11.52.23_PM.png)

Storage cluster here stores the _source-of-truth_ , the database.
...
![Screenshot_2024-03-09_at_12.15.42_AM](https://raw.githubusercontent.com/sounak07/backend-engineering/main/assets/Screenshot_2024-03-09_at_12.15.42_AM.png)

_Parallel fetching and Batching_
...
_UDP for reads and TCP for writes_
...
_Stale sets_ occurs when a invalid data is updated into the cache and its doesn't get validated.
_Thundering Herd problem_ where a single cache miss could cause concurrent requests occurs on the server by many clients for the same key.
...
This way cases of _stale sets_ are prevented as this way the old value will not be updated into the cache.
...
![Screenshot_2024-03-10_at_12.05.39_AM](https://raw.githubusercontent.com/sounak07/backend-engineering/main/assets/Screenshot_2024-03-10_at_12.05.39_AM.png)
...
![Screenshot_2024-03-10_at_12.44.14_AM](https://raw.githubusercontent.com/sounak07/backend-engineering/main/assets/Screenshot_2024-03-10_at_12.44.14_AM.png)
...
![Screenshot_2024-03-10_at_12.26.35_AM](https://raw.githubusercontent.com/sounak07/backend-engineering/main/assets/Screenshot_2024-03-10_at_12.26.35_AM.png)
...
So whenever a write request comes to the secondary server for say key _k_ , it sets a remote marker R and the write request is made to the primary region. Finally that key is deleted from secondary memcache server.
