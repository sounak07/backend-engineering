...
- Simple - Choose the correct data type for the data that we are trying to store. Use `int` for integers , `datetime` for dates. _Don't use string for dates_
...
![Screenshot_2024-02-18_at_11.46.49_PM](https://raw.githubusercontent.com/sounak07/backend-engineering/main/assets/Screenshot_2024-02-18_at_11.46.49_PM.png)

A `TINYINT` can store 1 byte or 8 bits so it can store 0 to 255 as shown or -128 to 127 in case it supports `-ve` numbers.

![Screenshot_2024-02-18_at_11.51.28_PM](https://raw.githubusercontent.com/sounak07/backend-engineering/main/assets/Screenshot_2024-02-18_at_11.51.28_PM.png)
...
![Screenshot_2024-02-18_at_11.54.09_PM](https://raw.githubusercontent.com/sounak07/backend-engineering/main/assets/Screenshot_2024-02-18_at_11.54.09_PM.png)
...
_Note :There are case of trying to change `INT` like as `INT(3)` , but this wrong._
...
Data types available to store in strings are

![Screenshot_2024-02-27_at_11.27.20_PM](https://raw.githubusercontent.com/sounak07/backend-engineering/main/assets/Screenshot_2024-02-27_at_11.27.20_PM.png)

`char` is going to occupy full space allowed while `varchar` only occupies whats needed.

![Screenshot_2024-02-27_at_11.38.32_PM](https://raw.githubusercontent.com/sounak07/backend-engineering/main/assets/Screenshot_2024-02-27_at_11.38.32_PM.png)
...
![Screenshot_2024-02-28_at_12.18.49_AM](https://raw.githubusercontent.com/sounak07/backend-engineering/main/assets/Screenshot_2024-02-28_at_12.18.49_AM.png)
![Screenshot_2024-02-28_at_12.16.56_AM](https://raw.githubusercontent.com/sounak07/backend-engineering/main/assets/Screenshot_2024-02-28_at_12.16.56_AM.png)
...
_Note: 0 is reserved for the invalid data._

##### Dates

![Screenshot_2024-03-03_at_7.26.41_PM](https://raw.githubusercontent.com/sounak07/backend-engineering/main/assets/Screenshot_2024-03-03_at_7.26.41_PM.png)
...
![Screenshot_2024-03-03_at_7.35.43_PM](https://raw.githubusercontent.com/sounak07/backend-engineering/main/assets/Screenshot_2024-03-03_at_7.35.43_PM.png)

As we can see we can update `updated_at` with current stamp but on update.

##### JSON

![Screenshot_2024-03-03_at_7.42.48_PM](https://raw.githubusercontent.com/sounak07/backend-engineering/main/assets/Screenshot_2024-03-03_at_7.42.48_PM.png)
...
![Screenshot_2024-03-10_at_3.48.22_PM](https://raw.githubusercontent.com/sounak07/backend-engineering/main/assets/Screenshot_2024-03-10_at_3.48.22_PM.png)
...
![Screenshot_2024-03-10_at_4.04.24_PM](https://raw.githubusercontent.com/sounak07/backend-engineering/main/assets/Screenshot_2024-03-10_at_4.04.24_PM.png)
...
![Screenshot_2024-03-10_at_4.29.54_PM](https://raw.githubusercontent.com/sounak07/backend-engineering/main/assets/Screenshot_2024-03-10_at_4.29.54_PM.png)
